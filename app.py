...
SMTPSettings = email_service.SMTPSettings


def _load_smtp_settings() -> SMTPSettings:
    return email_service.load_smtp_settings()


def _send_email_message(
    msg, normalized_recipient: str, settings: SMTPSettings
) -> None:
    email_service.send_email_message(
        msg,
        normalized_recipient,
        settings,
        smtp_class=SMTP,
        smtp_ssl_class=SMTP_SSL,
    )
