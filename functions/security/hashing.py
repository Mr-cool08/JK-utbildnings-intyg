...
from functions.constants import DEFAULT_HASH_ITERATIONS, SALT, TEST_HASH_ITERATIONS
...
def normalize_email(email: str) -> str:
    ...
    if "@" not in cleaned or cleaned.startswith("@") or cleaned.endswith("@"):  # noqa: W503
        raise ValueError(
