...
3. **Kör applikationen**
   ...
   python app.py
   ```
   Appen svarar på <http://localhost:8000> om du inte sätter `PORT` i `.env`.
...
* `smtp_from` – valfri avsändaradress (From + SMTP-avsändare) om `smtp_user` inte är en fullständig e-postadress.
